...
---------------------------------------------------------------------------------------------*/			
		...
		initButtons:function($target, level){
			...
			$target.find(".LOM-local-isPage").find(".ico-SNAP-edit").click(function(){that.editLbx("editpage", this);});
			$target.find(".LOM-local-isFolder").find(".ico-SNAP-edit").click(function(){that.editLbx("editfolder", this);});
			...
			if(
			   ...
			   (
				...
				$target.find(".ico-SNAP-delete").click(function(){that.delete(this);});
