				...
				config: (Utils.lang === "en")
                    ...
                    ribbonPicker: {
                        ...
                        lbxTitle: (Utils.lang === "en")
                            ? "Ribbons icons"
                            : "Ruban d'icône",
                        toggle: (Utils.lang === "en")
                            ? "Add a ribbon icon to this text element?"
                            : "Ajouter un ruban d'icône à cet élément ?",
                        settingsTitle: (Utils.lang === "en")
                            ? "Ribbon icon settings"
                            : "Paramètres du ruban d'icône",
                        ribbonPicker: (Utils.lang === "en")
                            ? "Ribbon icon"
                            : "Ruban d'icône",
                        label: (Utils.lang === "en")
                            ? "Icon:"
                        ...
                        icons: {
                            ...
                            dyk: (Utils.lang === "en")
                                ? "Did you know?"
                                : "Le saviez-vous ?",
                            warning: (Utils.lang === "en")
                                ? "Warning"
                                : "Attention",
                            information: (Utils.lang === "en")
                                ? "Info"
                                : "Info",
                            clock: (Utils.lang === "en")
                                ? "Duration"
                                : "Durée",
                            objective: (Utils.lang === "en")
                                ? "Objective"
                                : "Objectif",
                            exam: (Utils.lang === "en")
                                ? "Final Exam"
                            ...
                            activity: (Utils.lang === "en")
                                ? "Activity"
                                : "Activité",
                            example: (Utils.lang === "en")
                                ? "Example"
                                : "Exemple",
                            tip: (Utils.lang === "en")
                                ? "Tip"
                                : "Conseil",
                            document: (Utils.lang === "en")
                                ? "Document"
                                : "Document",
                            graphic: (Utils.lang === "en")
                                ? "Graphic"
                                : "Graphique",
                            link: (Utils.lang === "en")
                                ? "Link"
                                : "Lien",
                            moduleEnd: (Utils.lang === "en")
                                ? "Module end"
                                : "Fin du module",
                            courseEnd: (Utils.lang === "en")
                                ? "Course end"
                                : "Fin du cours"
                        }
                    },  
